...
const App: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold text-center mb-8">Análisis de Adicción a Redes Sociales</h1>

      {/* Formulario/Card para seleccionar acciones */}
      <AnalysisCard setSelectedAction={setSelectedAction} />

      {/* Resultados según la acción seleccionada */}
      {data && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {selectedAction === 'age' && (
            <div className="p-4 bg-white shadow rounded">
              ...
              <p>Rango de edades: {data.age_info.min_age} - {data.age_info.max_age} años</p>
